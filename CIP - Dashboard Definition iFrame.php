            ...
            $.ajax( {
                ...
                "success":  function ( json ) { ';
                    ...
                    $('#containerOpenExceptions').html(`<div class='mt-1'>
                        ...
                        <h3 style='font-size: 1.2em; color: #E7A65F; font-weight: bold; text-align: center; fill: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif;'>Open Exceptions</h3>
                    ...
                    $('#containerCompletedExceptions').html(`<div class='mt-1'>
                        <div style='background: white; cursor: pointer; padding-top: 0.45rem; padding-left: 2rem; padding-right: 2rem; padding-bottom: 2rem;'>
                        <h3 style='font-size: 1.2em; color: #E7A65F; font-weight: bold; text-align: center; fill: rgb(51, 51, 51); font-family: Helvetica, Arial, sans-serif;'>Completed Exceptions</h3>
